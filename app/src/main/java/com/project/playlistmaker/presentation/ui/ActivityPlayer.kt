...
import com.project.playlistmaker.domain.use_cases.PlayBackControlUseCase
import com.project.playlistmaker.domain.use_cases.utilities.DataFormat
import com.project.playlistmaker.player.player_interactor.PlayerInterectorImpl
import com.project.playlistmaker.player.update_duration.UpdateDurationTaskImpl
...
class ActivityPlayer : AppCompatActivity() {
    ...
    private val playerInterectorImpl = PlayerInterectorImpl()
